...
CREATE TABLE if not exists Dispositivos (Modelo varchar(20) not null, Numero_de_Serie varchar(25) not null, Direccion_de_Instalacion varchar(30),
Fecha datetime, Coordenadas varchar(20), Estado varchar(20)
);
